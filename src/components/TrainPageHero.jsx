...
const TrainPageHero = () => {
  return (
    <section className="w-full h-[40dvh] relative z-0">
      {/* bgimg  */}
      <div className="w-full h-full bg-train-img-2 bg-center bg-no-repeat bg-cover absolute z-0">
      ...
      <div className="h-full w-[90%] mx-auto flex flex-col gap-6 text-center md:text-start justify-center z-10 absolute inset-0 px-8">
        ...
        <ParaText>
          Real-time data of all trains currently on the move across Finland.
        </ParaText>
      </div>
    </section>
  );
